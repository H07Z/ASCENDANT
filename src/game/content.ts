...
export const ENEMIES: Record<string, EnemyDef> = {
  // Ashen Plains
  boar: { id: "boar", name: "Tusk Boar", artKey: "boar", color: "#c98a5a", ai: "charger", hp: 70, atk: 12, def: 4, xp: 18, gold: 9, size: [5, 3] },
  plains_wolf: { id: "plains_wolf", name: "Dust Wolf", artKey: "wolf", color: "#b9a98c", ai: "walker", hp: 60, atk: 14, def: 3, xp: 20, gold: 10, size: [6, 3] },
  goblin: { id: "goblin", name: "Scrap Goblin", artKey: "goblin", color: "#8fd17a", ai: "walker", hp: 52, atk: 11, def: 2, xp: 16, gold: 12, size: [4, 3] },
  bandit: { id: "bandit", name: "Road Bandit", artKey: "bandit", color: "#cda3a3", ai: "walker", hp: 80, atk: 16, def: 5, xp: 26, gold: 18, size: [5, 3] },
  // Dark Forest
  forest_beast: { id: "forest_beast", name: "Thicket Beast", artKey: "beast", color: "#6fbf6f", ai: "charger", hp: 110, atk: 18, def: 5, xp: 30, gold: 14, size: [6, 3] },
  treant: { id: "treant", name: "Grove Treant", artKey: "treant", color: "#5a9d5a", ai: "turret", hp: 180, atk: 16, def: 12, xp: 40, gold: 16, size: [5, 3] },
  dark_elf: { id: "dark_elf", name: "Dusk Elf", artKey: "mage", color: "#9b6bff", ai: "flyer", hp: 90, atk: 22, def: 4, xp: 34, gold: 20, size: [5, 3], ranged: true },
  shadow_wolf: { id: "shadow_wolf", name: "Shadow Wolf", artKey: "wolf", color: "#7a6cff", ai: "walker", hp: 96, atk: 24, def: 4, xp: 32, gold: 18, size: [6, 3] },
  // Ancient Ruins
  skeleton: { id: "skeleton", name: "Bone Sentinel", artKey: "skeleton", color: "#d8d2b8", ai: "walker", hp: 120, atk: 24, def: 6, xp: 38, gold: 18, size: [5, 3] },
  ruin_guard: { id: "ruin_guard", name: "Ruin Guardian", artKey: "knight", color: "#c9b483", ai: "walker", hp: 200, atk: 26, def: 16, xp: 52, gold: 24, size: [5, 3] },
  ancient_knight: { id: "ancient_knight", name: "Ancient Knight", artKey: "knight", color: "#e0c870", ai: "charger", hp: 240, atk: 32, def: 18, xp: 64, gold: 30, size: [5, 3] },
  construct: { id: "construct", name: "Ruin Construct", artKey: "construct", color: "#b0a0c8", ai: "turret", hp: 300, atk: 28, def: 22, xp: 70, gold: 22, size: [5, 4], ranged: true },
  // Frozen Wastes
  ice_wolf: { id: "ice_wolf", name: "Frost Wolf", artKey: "icewolf", color: "#9fe0ff", ai: "walker", hp: 150, atk: 30, def: 8, xp: 46, gold: 20, size: [6, 3] },
  frost_goblin: { id: "frost_goblin", name: "Frost Goblin", artKey: "goblin", color: "#a0e8ff", ai: "walker", hp: 130, atk: 28, def: 6, xp: 44, gold: 22, size: [4, 3] },
  ice_golem: { id: "ice_golem", name: "Ice Golem", artKey: "icegolem", color: "#bfeeff", ai: "turret", hp: 420, atk: 34, def: 28, xp: 90, gold: 26, size: [6, 4] },
  frost_knight: { id: "frost_knight", name: "Frost Knight", artKey: "knight", color: "#cfeaff", ai: "charger", hp: 320, atk: 40, def: 24, xp: 84, gold: 32, size: [5, 3] },
  // Demon Lands
  demon_soldier: { id: "demon_soldier", name: "Demon Soldier", artKey: "demon", color: "#ff7a5a", ai: "walker", hp: 220, atk: 42, def: 14, xp: 70, gold: 28, size: [6, 4] },
  hell_beast: { id: "hell_beast", name: "Hell Beast", artKey: "hellbeast", color: "#ff5a3a", ai: "charger", hp: 300, atk: 48, def: 12, xp: 92, gold: 30, size: [6, 4] },
  demon_knight: { id: "demon_knight", name: "Demon Knight", artKey: "knight", color: "#ff8a4a", ai: "charger", hp: 380, atk: 54, def: 26, xp: 110, gold: 38, size: [5, 3] },
  abyss_mage: { id: "abyss_mage", name: "Abyssal Mage", artKey: "mage", color: "#c44bff", ai: "flyer", hp: 240, atk: 60, def: 10, xp: 96, gold: 40, size: [5, 3], ranged: true },
  // Floating Realm
  sky_beast: { id: "sky_beast", name: "Sky Beast", artKey: "skybeast", color: "#bfe0ff", ai: "flyer", hp: 300, atk: 52, def: 16, xp: 100, gold: 34, size: [7, 4], ranged: true },
  float_guard: { id: "float_guard", name: "Floating Guardian", artKey: "floatguard", color: "#d0c4ff", ai: "flyer", hp: 360, atk: 50, def: 30, xp: 120, gold: 36, size: [5, 3] },
  arcane_construct: { id: "arcane_construct", name: "Arcane Construct", artKey: "construct", color: "#9ad8ff", ai: "turret", hp: 520, atk: 56, def: 38, xp: 150, gold: 30, size: [5, 4], ranged: true },
  celestial_knight: { id: "celestial_knight", name: "Celestial Knight", artKey: "knight", color: "#fff0b0", ai: "charger", hp: 460, atk: 64, def: 34, xp: 160, gold: 46, size: [5, 3] },
};
