...
export const SKILLS: Record<string, SkillDef> = {
  ...
  multi_shot: {
    ...
    name: "Arrow Shower",
    kind: "projectile",
    desc: "Launch an arcing shower of three arrows that rain down in explosive area bursts.",
    mana: 20,
    cd: 5,
    mult: 1.6,
    range: 22,
  ...
  arcane_burst: {
    ...
    name: "Arcane Orb",
    kind: "projectile",
    desc: "Channel a massive orb of raw arcane energy. Locks movement while active.",
    mana: 35,
    cd: 8,
    mult: 3.2,
    range: 18,
  ...
  bombard: {
    ...
    name: "Bombard",
    kind: "projectile",
    desc: "Launch a long-range mortar shell in a high arcing trajectory that detonates on impact.",
    mana: 30,
    cd: 7,
    mult: 3.2,
    range: 22,
